...
if args.token is None:
    ...
    #         logger.info("Your current time is: " +
    ...
    #     list_of_all_pair_codes = pair_codes.split(',')
    ...
    #         for code in list_of_all_pair_codes:
    #             if latest_price.pair_code.find(code) == -1:
    #                 list_of_all_missing_latest_pairs.append(code)

    #         if lag >= three_min_lag and lag < five_min_lag:
    #             logger.info(
    #                 f'V1(2000): {latest_price.pair_code} is within 3-4 minutes of current time, difference: {lag}')
    #         else:
    ...
    #             logger.info(
    #                 f'V1(2000): {latest_price.pair_code} is NOT within 3-4 minutes of current time, difference: {lag}')
    ...
    #         if lag <= one_min_lag and match:
    #             logger.info(
    #                 f'V1(10500): {latest_price.pair_code} is within current time: difference: {lag} & prices include sub-pennies ({latest_price.prices})')
    #         else:
    ...
    #             list_of_affected_latencies.append(latest_price)
    #             logger.info(
    #                 f'V1(10500): {latest_price.pair_code} is NOT within current time, difference: {lag} or prices doesn\'t include sub-pennies ({latest_price.prices})')
    ...
    #         if lag >= three_min_lag and lag < five_min_lag:
    #             logger.info(
    #                 f'V3(2000): {latest_price.pair_code} is within 3-4 minutes of current time, difference: {lag}')
    #         else:
    ...
    #             list_of_affected_latencies.append(latest_price)
    #             logger.info(
    #                 f'V3(2000): {latest_price.pair_code} is NOT within 3-4 minutes of current time, difference: {lag}')
    #         # if any(x in list_of_pair_codes for x in latest_price.pair_code):
    #         #     list_of_all_missing_latest_pairs.append(latest_price.pair_code)
